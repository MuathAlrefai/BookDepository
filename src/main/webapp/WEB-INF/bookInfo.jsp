        ...
        <div class="container__content">
            <div class="content__profile"><img src="${book.cover}" alt="${book.name}">
                <div class="profile">
                    ...
                    <p>
                    <form action="/author/follow/${book.author.id}" method="post">
            ...
            <div class="content__bio">
                ...
                <form:form action="/buyBook" method="post" modelAttribute="purchase">
                    <form:input type="hidden" path="user" value="${currentUser.id}"/>
                    <form:input type="hidden" path="book" value="${book.id}"/> <br>

                    <input type="submit" class="btn btn-primary" value="Buy" style="width: 150px; font-size: larger;">
                </form:form>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="d-flex flex-row user-feed"><c:if test="${currentUser.id == review.user.id}"><span class="ml-3"><i class="fa fa-comments-o mr-2"></i>
                                            <form action="/review/delete/${review.id}" method="get">
                                                ...
                                                <input type="submit" value="delete" style="color: tomato; background: none; border: none;">
                                            </form>
                                    </span></c:if></div>
                                    </div>
                                </div>
