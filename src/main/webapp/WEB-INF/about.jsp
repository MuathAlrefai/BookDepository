...
<div class="team-boxed">
  <div class="container">
    <div class="intro">
      ...
      <p class="text-center">Welcome to Book Depository, your one-stop destination for all things books!</p>
    </div>
    <div class="intro">
      <h2 class="text-center">Our Story </h2>
      <p class="text-center">Book Depository was founded with a passion for literature and a vision to make books accessible to readers worldwide. We believe in the power of books to inspire, entertain, and educate. Our mission is to connect book lovers with their next great read by providing an extensive collection of titles across various genres.</p>
    </div>
    <div class="intro">
      <h2 class="text-center">Team </h2>
      <p class="text-center">Our humble members :)</p>
    </div>
    <div class="row people">
      <div class="col-md-6 col-lg-4 item">
        <div class="box"><img class="rounded-circle" src="/assets/mahmoud.png">
          <h3 class="name">Mahmoud Attieh</h3>
          <p class="title">Software Engineer</p>
          <p class="description">Graduated Software Engineering and decided to continue studying Full Stack Development</p>
          <div class="social"><a href="https://github.com/Mahmoud-Attieh"><i class="fab fa-github"></i></a><a href="https://www.linkedin.com/in/mahmoud-attieh-035aa6192/"><i class="fab fa-linkedin"></i></a><a href="https://leetcode.com/Mahmoud-Attieh/"><i class="fab fa-hackerrank"></i></a></div>
        </div>
      </div>
      <div class="col-md-6 col-lg-4 item">
        <div class="box"><img class="rounded-circle" src="/assets/muath.png">
          <h3 class="name">Muath Al-Refai</h3>
          <p class="title">Full Stack Developer</p>
          <p class="description">Graduated Civil Engineering, then decided to career shift to Programming </p>
          <div class="social"><a href="http://github.com/MuathAlrefai"><i class="fab fa-github"></i></a><a href="https://www.linkedin.com/in/muath-alrefai-46723b280/"><i class="fab fa-linkedin"></i></a><a href="https://leetcode.com/MuathAlrefai/"><i class="fab fa-hackerrank"></i></a></div>
        </div>
      </div>
      <div class="col-md-6 col-lg-4 item">
        <div class="box"><img class="rounded-circle" src="/assets/enzo.jpg">
          <h3 class="name">Mohamad Dayem</h3>
          <p class="title">Full Stack Developer</p>
          <p class="description">Graduate Project Management, then decided to career shift to Programming</p>
          <div class="social"><a href="https://github.com/MohamadDayem"><i class="fab fa-github"></i></a><a href="#"><i class="fab fa-linkedin"></i></a><a href="#"><i class="fab fa-hackerrank"></i></a></div>
        </div>
      </div>
    </div>
  </div>
