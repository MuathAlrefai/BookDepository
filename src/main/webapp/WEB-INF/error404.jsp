...
<!-- NAV BAR -->
<%-- CONTENT --%>
  <img src="/assets/error404.png" alt="error404" class="rounded mx-auto d-block"><br>
  <p style="text-align: center;"><a href="/home" style="padding: 20px;" class="btn btn-dark">Homepage>></a></p>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 footer-column">
          <div class="logo-widget footer-widget">
            <div style="display: flex; justify-content: start; align-items: center;">
              ...
              <figure class="logo-box"><a class="navbar-brand text-white" href="/adminHome" style="line-height: 20px;">Book<br>Depository</a></figure>
            </div>
            <div class="text">
            ...
            <ul class="footer-social">
              ...
              <li><a href="https://github.com/MuathAlrefai/BookDepository"><i class="fab fa-github"></i></a></li>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 offset-lg-4 footer-column">
          <div class="service-widget footer-widget">
            ...
            <ul class="list">
              ...
              <li><a href="#">Ramallah - Beereh</a></li>
            </ul>
          </div>
        </div>
      </div>
