...
<main>
  <table class="customer-table">
    <caption style="text-align: center;">Books Info</caption>
    <thead>
    <tr>
      <th>Name</th>
      <th>Author</th>
    ...
    <c:forEach var="book" items="${books}">
      <tr>
        <th><a href="/books/${book.id}"><c:out value="${book.name}"/></a></th>
        <td><a href="/author/${book.author.id}"><c:out value="${book.author.name}"/></a></td>
        <td><a href="/publisher/${book.publisher.id}"><c:out value="${book.publisher.name}"/></a></td>
        <td><a href="/book/delete/${book.id}" class="btn btn-danger" style="font-size: smaller; text-align: center;"><b>DELETE</b></a></td>
      </tr>
    </c:forEach>
    </tbody>
  </table>
