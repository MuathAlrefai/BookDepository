...
<main>
  <table class="customer-table">
    <caption style="text-align: center;">Customer Info</caption>
    <thead>
    <tr>
      <th>Name</th>
      <th>Email</th>
    ...
    <tr>
      ...
      <td><a href="/banUser/${user.id}" class="btn btn-danger" style="font-size: smaller; text-align: center;"><b>BAN</b></a></td>
    </tr>
    </c:forEach>
    </tbody>
  </table>
