...
<%-- CONTENT --%>
<br><br>
<div style=" margin-right: 100px; display: flex; justify-content: space-evenly; align-items: center; text-align: center;">
  <br><br><br>
  <h2><a href="/bookForm" class="btn btn-info text-white">Add Book</a></h2>
  <h2><a href="/authorForm" class="btn btn-info text-white">Add Author</a></h2>
  <h2><a href="/publisherForm" class="btn btn-info text-white">Add Publisher</a></h2>
  <h2><a href="/genreForm" class="btn btn-info text-white">Add Genre</a></h2>
</div>
