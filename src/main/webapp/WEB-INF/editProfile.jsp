...
<div style="margin-left: 50px; margin-right: 50px; display: flex; justify-content: space-evenly; align-items: center;">
  <div>
    ...
    <form action="/updateUser" method="post">
      ...
      <input name="userName" value="${currentUser.userName}" type="text"/><br><br>

      <label style="width: 100px;">Email:</label>
      <input name="email" value="${currentUser.email}" type="text"/><br><br>

      <label style="width: 100px;">Avatar:</label>
      <spoiler><input name="avatar" value="${currentUser.avatar}" type="text"/><br><br></spoiler>
  ...
  <img src="/assets/edit.png" alt="edit" style="width: 20%;">
</div>
