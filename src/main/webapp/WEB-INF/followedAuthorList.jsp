...
<main>
  <table class="customer-table">
    <caption style="text-align: center;">Authors You Follow</caption>
    <thead>
    <tr>
      <th>Name</th>
      <th>Books #</th>
    ...
    <tbody>
    <c:forEach var="author" items="${currentUser.authors}">
      <tr>
        <th><a href="/author/${author.id}"><c:out value="${author.name}"/></a></th>
        <th><c:out value="${author.authorBooks.size()}"/></th>
      </tr>
    </c:forEach>
    </tbody>
  </table>
